  ...
  return (
    <div className="space-y-8">
      <div className="gradient-hero card-premium p-6 rounded-2xl elevation-sm">
        <h1 className="heading-display">INNOVX — Innovation Research Engine</h1>
        <p className="text-base text-muted-foreground mt-2 max-w-2xl">Explore companies' innovation roadmaps, strategic pillars and project portfolios. Click a company for a deep-dive into their innovation landscape.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filtered.map(c => (
          <CompanyCard
            ...
            company={c as any}
            delay={0}
            onClick={() => navigate(`/companies/${c.company_id}/innovx`)}
          />
        ))}
      </div>
    </div>
